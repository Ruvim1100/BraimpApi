...
public class UpdateCourseThumbnailCommandValidator : AbstractValidator<UpdateCourseThumbnailCommand>
{
    private readonly IBraimpDbContext _dbContext;
    private static readonly string[] AllowedExtensions = [".jpg", ".jpeg", ".png", ".webp"];

    public UpdateCourseThumbnailCommandValidator(IBraimpDbContext dbContext)
    {
    ...
    private async Task<bool> CourseExists(UpdateCourseThumbnailCommand command, CancellationToken cancellationToken) =>
