        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ThumbnailResourceId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    BannerResourceId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AnswerOptions_AttemptAnswers_AttemptAnswerId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AnswerTexts_AttemptAnswers_AttemptAnswerId",
                        column: x => x.AttemptAnswerId,
                        principalTable: "AttemptAnswers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AnswerOptions_AttemptAnswerId",
                table: "AnswerOptions",
                column: "AttemptAnswerId");

            migrationBuilder.CreateIndex(
                name: "IX_AnswerTexts_AttemptAnswerId",
                table: "AnswerTexts",
                column: "AttemptAnswerId");
