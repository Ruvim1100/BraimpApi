...
namespace Braimp.Infrastructure.Migrations
{
    ...
    [Migration("20250717130033_FixNewsEntity")]
    partial class FixNewsEntity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Braimp.Domain.Entities.LearningContent.LessonBlock", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Braimp.Domain.Entities.Courses.CourseParticipant", b =>
                {
                    ...
                    b.HasOne("Braimp.Domain.Entities.Users.User", "User")
                        .WithMany("Courses")
